...
В боте VK есть клавиатура с кнопками:

| Кнопка | Действие |
|---|---|
| 📋 Список чатов | Показать все чаты и их статус |
...
- `/t <id>` — переключить (вкл/выкл) чат по ID
- `/all_on` — включить все чаты
- `/all_off` — выключить все чаты
